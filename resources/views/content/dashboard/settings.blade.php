    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          <img src="{{ asset(auth()->user()->avatar) }}" alt="user-avatar" class="d-block rounded" height="100" width="100"  id="uploadedAvatar" style="object-fit: cover;" />
      ...
      <div class="card-body">
          <div class="row">
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="text" id="fullname" name="fullname" value="{{ auth()->user()->fullname }}" autofocus />
              @error('fullname')
            ...
            <div class="mb-3 col-md-6">
              ...
              <input type="number" class="form-control" id="nim" name="nim" value="{{ auth()->user()->nim }}" />
              @error('nim')
                  <div class="invalid-feedback d-block">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <select name="department_id" id="department_id" class="form-select @error('department_id') invalid @enderror">
            ...
            <div class="col-12 col-sm-6 col-md-5 col-lg-4 col-xl-3 mt-3">
                <div class="row g-3">
                    <div class="col-12 custom-col">
                        ...
                        <div id="sign" class="kbw-signature form-control @error('signature') invalid @enderror"></div>
                        <textarea name="signature" id="signature" class="d-none"></textarea>
                        @error('signature')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                        <button id="clear" class="btn btn-danger btn-sm mt-2">Bersihkan TTD</button>
                    </div>
                </div>
            </div>
            @else
            <div class="col-12">
              ...
              <img src="{{ asset(auth()->user()->signature) }}" alt="TTD {{ auth()->user()->fullname }}" style="width: 220px; height: 140px;" class="border rounded me-3">
