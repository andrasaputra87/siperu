            ...
            @foreach ($tahun_ajarans as $tahun_ajaran)
                <div class="col-12 col-md-6 col-lg-4 col-xxl-3 mb-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <h5 class="text-truncate">{{ $tahun_ajaran->tahun_ajaran }} 
                                </h5>
                            <div class="d-flex gap-2 mb-3">
                                <a href="{{ route('sessions.show', $tahun_ajaran->id) }}"
                                    class="btn btn-primary d-block">Atur Sesi Waktu</a>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center p-5">
                        <h2 class="text-primary">Tahun Ajaran Kosong!</h2>
                        <p class="mb-5">Ups! 😥 silahkan tambah tahun ajaran terlebih dahulu.</p>
