  ...
  <header class="tg-header">
    <div class="row">
      ...
      <div class="col-8">
        ...
        <h2 class="tg-h2">Daftar Jadwal dari <b>{{ $room->name}}</b></h2>
    ...
    <div class="main">
      ...
      <div class="row main-row">
        <div class="col-2 col-menu">
          <div class="menu-wrap">
            <div class="menu">
              <h6 class="filter-title">Cari Tanggal</h6>
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                    <form action="" method="GET">
                      <input type="date" name="cari" class="form-control" placeholder="Cari Data" value="{{ old('cari') }}">
