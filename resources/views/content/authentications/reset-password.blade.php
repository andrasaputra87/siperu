      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
              ...
              <span class="app-brand-text demo text-body fw-bolder">Siperu</span>
            </a>
          </div>
          <!-- /Logo -->
          <h4 class="mb-2">Atur Ulang Kata Sandi 🔒</h4>
          <p class="mb-4">Untuk <span class="fw-bold">{{ request()->email }}</span></p>
          @if ($errors->any())
          ...
          <form class="mb-3" action="{{ route('password.update') }}" method="POST">
            ...
            <div class="mb-3 form-password-toggle">
              ...
              <div class="input-group input-group-merge">
                <input type="password" id="password" class="form-control @error('password') border-danger @enderror" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
