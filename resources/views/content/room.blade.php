        ...
        @if ($building->floor > 0)
            <div class="text-center">
                @for ($i = 1; $i <= $building->floor; $i++)
                    <a class="btn btn-primary" href="/get_room/{{ $building_id }}/Lantai {{ $i }}"
                                ...
                                <div class="input-group-text">
                                    <form action="" method="GET">
                                        <input type="text" name="cari" class="form-control"
                                            placeholder="Cari Data" value="{{ old('cari') }}">
                        ...
                        @foreach ($rooms as $room)
                            <div class="col-3 col-card">
                                <div class="col-card__content">
                                    <div class="card">
                                        <img class="card-img-top" src="{{ asset($room->thumbnail) }}" alt="{{ $room->bname }}"
                                            height="200">
                                        <div class="card-body">
                                            ...
                                            @endif
                                            <p class="card-text">{{ count($room->roomReservations) }} Jadwal Peminjaman
                                                Ruangan</p>
                                            <a class="btn btn-primary" href="/get_jadwal/{{ $room->id }}/{{ $room->building_id }}">Lihat
                                                Jadwal</a>
                                        </div>
                                    </div>
                                </div>
                ...
                @else
                    <div class="col-8 col-cards">
                        ...
                        <div class="error-template">
                            ...
                            <h2>
                                @if ($cari != '')
                                    Hasil Pencarian "{{ $cari }}" Tidak Ditemukan
                            </h2>
